...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultNameBinding
...
class TestResultNameFragment: BaseTestResultFragment<LayoutTestResultNameBinding>(){
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.testAgain->{
                testAgain(LoveTestFragment.NAME_TYPE)
            }
            R.id.download->{
                actionDownload=true
    ...
    override fun getLayout(): Int {
        return R.layout.layout_test_result_name
    }
}