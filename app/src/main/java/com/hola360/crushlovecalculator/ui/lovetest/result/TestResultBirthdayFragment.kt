...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultBirthdayBinding
...
class TestResultBirthdayFragment: BaseTestResultFragment<LayoutTestResultBirthdayBinding>(){
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.testAgain->{
                testAgain(LoveTestFragment.BIRTHDAY_TYPE)
            }
            R.id.download->{
                actionDownload=true
    ...
    override fun getLayout(): Int {
        return R.layout.layout_test_result_birthday
    }
