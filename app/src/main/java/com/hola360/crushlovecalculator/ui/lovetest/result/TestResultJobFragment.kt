...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultJobBinding
...
class TestResultJobFragment: BaseTestResultFragment<LayoutTestResultJobBinding>(){
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.testAgain->{
                testAgain(LoveTestFragment.JOB_TYPE)
            }
            R.id.download->{
                actionDownload=true
    ...
    override fun getLayout(): Int {
        return R.layout.layout_test_result_job
    }
}