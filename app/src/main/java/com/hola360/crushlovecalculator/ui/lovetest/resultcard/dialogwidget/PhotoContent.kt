...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultDialogPhotoBinding
...
class PhotoContent(mainActivity: FragmentActivity, val callback: ResultCardDialog.ResultDialogCallback): BaseResultDialogWidget<LayoutTestResultDialogPhotoBinding>(mainActivity), View.OnClickListener {

    override val layoutId: Int
        get() = R.layout.layout_test_result_dialog_photo
