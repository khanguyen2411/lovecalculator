...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultDialogNationBinding
...
class NationalityContent(mainActivity: FragmentActivity, val callback: ResultCardDialog.ResultDialogCallback): BaseResultDialogWidget<LayoutTestResultDialogNationBinding>(mainActivity), View.OnClickListener {

    override val layoutId: Int
        get() = R.layout.layout_test_result_dialog_nation
