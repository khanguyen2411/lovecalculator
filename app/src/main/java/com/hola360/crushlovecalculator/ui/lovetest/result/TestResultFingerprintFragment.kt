...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultFingerprintBinding
...
class TestResultFingerprintFragment: BaseTestResultFragment<LayoutTestResultFingerprintBinding>(){
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.testAgain->{
                testAgain(LoveTestFragment.FINGERPRINT_TYPE)
            }
            R.id.download->{
                actionDownload=true
    ...
    override fun getLayout(): Int {
        return R.layout.layout_test_result_fingerprint
    }
}