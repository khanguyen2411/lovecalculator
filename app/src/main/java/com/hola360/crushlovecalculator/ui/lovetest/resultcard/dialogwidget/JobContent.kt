...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultDialogJobBinding
...
class JobContent(mainActivity: FragmentActivity, val callback: ResultCardDialog.ResultDialogCallback): BaseResultDialogWidget<LayoutTestResultDialogJobBinding>(mainActivity), View.OnClickListener {

    override val layoutId: Int
        get() = R.layout.layout_test_result_dialog_job
