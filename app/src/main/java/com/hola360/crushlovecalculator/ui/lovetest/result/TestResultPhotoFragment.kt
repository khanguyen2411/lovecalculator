...
import com.hola360.crushlovecalculator.databinding.LayoutTestResultPhotoBinding
...
class TestResultPhotoFragment: BaseTestResultFragment<LayoutTestResultPhotoBinding>(){
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.testAgain->{
                testAgain(LoveTestFragment.PHOTO_TYPE)
            }
            R.id.download->{
                actionDownload=true
    ...
    override fun getLayout(): Int {
        return R.layout.layout_test_result_photo
    }
}